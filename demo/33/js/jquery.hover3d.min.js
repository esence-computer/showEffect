/*
 * @Author: your name
 * @Date: 2020-06-26 01:09:05
 * @LastEditTime: 2021-06-20 12:50:38
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \文字效果\test\demo-html-css-master\demo-html-css-master\demo\33\js\jquery.hover3d.min.js
 */
! function (e) {
    e.fn.hover3d = function (t) {
        ...
        return this.each(function () {
            function t(e) {
                i.addClass(r.hoverInClass + " " + r.hoverClass), currentX = currentY = 0, setTimeout(
                    function () {
            ...
            function s(e) {
                ...
                }), a.css("background", "linear-gradient(" + h + "deg, rgba(255,255,255," + e.offsetY /
                    s * .5 + ") 0%,rgba(255,255,255,0) 80%)")
            }
